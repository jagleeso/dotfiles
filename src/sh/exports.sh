...
export REMOTE_GAMBIT_NODE=gambit
...
export GAMBIT_SSH_PORT=7001
export GAMBIT_TENSORBOARD_PORT=7002
export GAMBIT_JUPYTER_PORT=7003

export ECO14_DASH_PORT=8143

export ECO17_SSH_PORT=8171
export ECO17_TENSORBOARD_PORT=8172
export ECO17_JUPYTER_PORT=8173
